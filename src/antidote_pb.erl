...
encode_msg_ApbGetSecureBoundedCounterResp(Msg,
					  TrUserData) ->
    encode_msg_ApbGetSecureBoundedCounterResp(Msg, <<>>,
					      TrUserData).


encode_msg_ApbGetSecureBoundedCounterResp(#'ApbGetSecureBoundedCounterResp'{increments
										=
										F1,
									    decrements
										=
...
encode_msg_ApbUpdateOperation(#'ApbUpdateOperation'{counterop
    ...
    if F8 == undefined -> B7;
	   ...
	   begin
	     ...
	     e_mfield_ApbUpdateOperation_secure_bcounterop(TrF8,
							   <<B7/binary, 74>>,
							   TrUserData)
	   end
    end.
...
encode_msg_ApbReadObjectResp(#'ApbReadObjectResp'{counter
    ...
    if F8 == undefined -> B7;
	   ...
	   begin
	     TrF8 = id(F8, TrUserData),
	     e_mfield_ApbReadObjectResp_secure_bcounter(TrF8,
							<<B7/binary, 74>>,
							TrUserData)
	   end
    end.
...
e_mfield_ApbUpdateOperation_secure_bcounterop(Msg, Bin,
					      TrUserData) ->
...
e_mfield_ApbReadObjectResp_secure_bcounter(Msg, Bin,
					   TrUserData) ->
    SubBin = encode_msg_ApbGetSecureBoundedCounterResp(Msg,
						       <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit('ApbGetSecureBoundedCounterResp', Bin,
		  TrUserData) ->
    id(decode_msg_ApbGetSecureBoundedCounterResp(Bin,
						 TrUserData),
       TrUserData);
...
dfp_read_field_def_ApbSecureBoundedCounterUpdate(<<18,
						 ...
						 Z1, Z2, F@_1, F@_2, F@_3,
						 TrUserData) ->
    d_field_ApbSecureBoundedCounterUpdate_dec(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData);
dfp_read_field_def_ApbSecureBoundedCounterUpdate(<<26,
						   Rest/binary>>,
						 Z1, Z2, F@_1, F@_2, F@_3,
						 TrUserData) ->
...
dfp_read_field_def_ApbSecureBoundedCounterUpdate(<<>>,
    ...
    #'ApbSecureBoundedCounterUpdate'{inc = F@_1, dec = F@_2,
				     nsquare = F@_3};
...
dg_read_field_def_ApbSecureBoundedCounterUpdate(<<0:1,
    ...
    case Key of
	  ...
	  d_field_ApbSecureBoundedCounterUpdate_inc(Rest, 0, 0,
						    ...
						    TrUserData);
      18 ->
	  d_field_ApbSecureBoundedCounterUpdate_dec(Rest, 0, 0,
						    F@_1, F@_2, F@_3,
						    TrUserData);
      26 ->
...
d_field_ApbSecureBoundedCounterUpdate_dec(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_ApbSecureBoundedCounterUpdate_dec(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2, F@_3,
					      TrUserData);
d_field_ApbSecureBoundedCounterUpdate_dec(<<0:1, X:7,
					    Rest/binary>>,
...
decode_msg_ApbGetSecureBoundedCounterResp(Bin,
					  TrUserData) ->
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Bin,
						      0, 0,
						      id(undefined, TrUserData),
						      id(undefined, TrUserData),
						      TrUserData).

dfp_read_field_def_ApbGetSecureBoundedCounterResp(<<10,
						    Rest/binary>>,
						  Z1, Z2, F@_1, F@_2,
						  TrUserData) ->
    d_field_ApbGetSecureBoundedCounterResp_increments(Rest,
						      Z1, Z2, F@_1, F@_2,
						      TrUserData);
dfp_read_field_def_ApbGetSecureBoundedCounterResp(<<18,
						    Rest/binary>>,
						  Z1, Z2, F@_1, F@_2,
						  TrUserData) ->
    d_field_ApbGetSecureBoundedCounterResp_decrements(Rest,
						      Z1, Z2, F@_1, F@_2,
						      TrUserData);
dfp_read_field_def_ApbGetSecureBoundedCounterResp(<<>>,
						  0, 0, F@_1, F@_2, _) ->
    #'ApbGetSecureBoundedCounterResp'{increments = F@_1,
				      decrements = F@_2};
dfp_read_field_def_ApbGetSecureBoundedCounterResp(Other,
						  Z1, Z2, F@_1, F@_2,
						  TrUserData) ->
    dg_read_field_def_ApbGetSecureBoundedCounterResp(Other,
						     Z1, Z2, F@_1, F@_2,
						     TrUserData).

dg_read_field_def_ApbGetSecureBoundedCounterResp(<<1:1,
						   X:7, Rest/binary>>,
						 N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ApbGetSecureBoundedCounterResp(Rest,
						     N + 7, X bsl N + Acc, F@_1,
						     F@_2, TrUserData);
dg_read_field_def_ApbGetSecureBoundedCounterResp(<<0:1,
						   X:7, Rest/binary>>,
						 N, Acc, F@_1, F@_2,
						 TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
	  ...
	  case Key band 7 of
	    0 ->
		skip_varint_ApbGetSecureBoundedCounterResp(Rest, 0, 0,
							   F@_1, F@_2,
							   TrUserData);
	    1 ->
		skip_64_ApbGetSecureBoundedCounterResp(Rest, 0, 0, F@_1,
						       F@_2, TrUserData);
	    2 ->
		skip_length_delimited_ApbGetSecureBoundedCounterResp(Rest,
								     0, 0, F@_1,
								     F@_2,
								     TrUserData);
	    3 ->
		skip_group_ApbGetSecureBoundedCounterResp(Rest,
							  Key bsr 3, 0, F@_1,
							  F@_2, TrUserData);
	    5 ->
		skip_32_ApbGetSecureBoundedCounterResp(Rest, 0, 0, F@_1,
						       F@_2, TrUserData)
	  end
    end;
dg_read_field_def_ApbGetSecureBoundedCounterResp(<<>>,
						 0, 0, F@_1, F@_2, _) ->
    #'ApbGetSecureBoundedCounterResp'{increments = F@_1,
				      decrements = F@_2}.

d_field_ApbGetSecureBoundedCounterResp_increments(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2,
						  TrUserData)
    when N < 57 ->
    d_field_ApbGetSecureBoundedCounterResp_increments(Rest,
						      N + 7, X bsl N + Acc,
						      F@_1, F@_2, TrUserData);
d_field_ApbGetSecureBoundedCounterResp_increments(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, _, F@_2,
						  TrUserData) ->
    {NewFValue, RestF} = begin
    ...
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(RestF,
						      0, 0, NewFValue, F@_2,
						      TrUserData).

d_field_ApbGetSecureBoundedCounterResp_decrements(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2,
						  TrUserData)
    when N < 57 ->
    d_field_ApbGetSecureBoundedCounterResp_decrements(Rest,
						      N + 7, X bsl N + Acc,
						      F@_1, F@_2, TrUserData);
d_field_ApbGetSecureBoundedCounterResp_decrements(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, _,
						  TrUserData) ->
    {NewFValue, RestF} = begin
...
skip_varint_ApbGetSecureBoundedCounterResp(<<1:1, _:7,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_ApbGetSecureBoundedCounterResp(Rest, Z1, Z2,
					       F@_1, F@_2, TrUserData);
skip_varint_ApbGetSecureBoundedCounterResp(<<0:1, _:7,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Rest,
						      Z1, Z2, F@_1, F@_2,
						      TrUserData).

skip_length_delimited_ApbGetSecureBoundedCounterResp(<<1:1,
						       X:7, Rest/binary>>,
						     N, Acc, F@_1, F@_2,
						     TrUserData)
    when N < 57 ->
    skip_length_delimited_ApbGetSecureBoundedCounterResp(Rest,
							 ...
							 F@_1, F@_2,
							 TrUserData);
skip_length_delimited_ApbGetSecureBoundedCounterResp(<<0:1,
						       X:7, Rest/binary>>,
						     N, Acc, F@_1, F@_2,
						     TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Rest2,
						      0, 0, F@_1, F@_2,
						      TrUserData).

skip_group_ApbGetSecureBoundedCounterResp(Bin, FNum, Z2,
					  F@_1, F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Rest,
						      0, Z2, F@_1, F@_2,
...
skip_32_ApbGetSecureBoundedCounterResp(<<_:32,
					 Rest/binary>>,
				       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Rest,
						      Z1, Z2, F@_1, F@_2,
...
skip_64_ApbGetSecureBoundedCounterResp(<<_:64,
					 Rest/binary>>,
				       Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ApbGetSecureBoundedCounterResp(Rest,
						      Z1, Z2, F@_1, F@_2,
...
dfp_read_field_def_ApbUpdateOperation(<<74,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, F@_7, F@_8, TrUserData) ->
    d_field_ApbUpdateOperation_secure_bcounterop(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 F@_5, F@_6, F@_7, F@_8,
						 TrUserData);
...
dg_read_field_def_ApbUpdateOperation(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_ApbUpdateOperation_secure_counterop(Rest, 0, 0,
						      ...
						      TrUserData);
      74 ->
	  d_field_ApbUpdateOperation_secure_bcounterop(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       F@_5, F@_6, F@_7, F@_8,
						       TrUserData);
      _ ->
...
d_field_ApbUpdateOperation_secure_bcounterop(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     F@_5, F@_6, F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_ApbUpdateOperation_secure_bcounterop(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, F@_5, F@_6,
						 F@_7, F@_8, TrUserData);
d_field_ApbUpdateOperation_secure_bcounterop(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     F@_5, F@_6, F@_7, Prev,
					     TrUserData) ->
...
dfp_read_field_def_ApbReadObjectResp(<<66,
    ...
    d_field_ApbReadObjectResp_secure_counter(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					     F@_7, F@_8, TrUserData);
dfp_read_field_def_ApbReadObjectResp(<<74,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				     F@_7, F@_8, TrUserData) ->
    d_field_ApbReadObjectResp_secure_bcounter(Rest, Z1, Z2,
...
dfp_read_field_def_ApbReadObjectResp(<<>>, 0, 0, F@_1,
    ...
    #'ApbReadObjectResp'{counter = F@_1, set = F@_2,
			 ...
			 secure_counter = F@_7, secure_bcounter = F@_8};
...
dg_read_field_def_ApbReadObjectResp(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_ApbReadObjectResp_secure_counter(Rest, 0, 0,
						   ...
						   TrUserData);
      74 ->
	  d_field_ApbReadObjectResp_secure_bcounter(Rest, 0, 0,
						    F@_1, F@_2, F@_3, F@_4,
						    F@_5, F@_6, F@_7, F@_8,
						    TrUserData);
      _ ->
...
d_field_ApbReadObjectResp_secure_bcounter(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					  F@_6, F@_7, F@_8, TrUserData)
    when N < 57 ->
    d_field_ApbReadObjectResp_secure_bcounter(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2, F@_3,
					      F@_4, F@_5, F@_6, F@_7, F@_8,
					      TrUserData);
d_field_ApbReadObjectResp_secure_bcounter(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_ApbGetSecureBoundedCounterResp(Bs,
									 TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_ApbReadObjectResp(RestF, 0, 0, F@_1,
					 ...
					 if Prev == undefined -> NewFValue;
					    true ->
						merge_msg_ApbGetSecureBoundedCounterResp(Prev,
											 NewFValue,
											 TrUserData)
					 end,
					 TrUserData).
...
merge_msg_ApbSecureBoundedCounterUpdate(#'ApbSecureBoundedCounterUpdate'{inc
									     =
									     PFinc,
									 dec =
									     PFdec,
...
merge_msg_ApbUpdateOperation(#'ApbUpdateOperation'{counterop
    ...
    #'ApbUpdateOperation'{counterop =
			  ...
			  secure_bcounterop =
			      if PFsecure_bcounterop /= undefined,
				 NFsecure_bcounterop /= undefined ->
				     merge_msg_ApbSecureBoundedCounterUpdate(PFsecure_bcounterop,
									     NFsecure_bcounterop,
									     TrUserData);
				 PFsecure_bcounterop == undefined ->
				     NFsecure_bcounterop;
				 NFsecure_bcounterop == undefined ->
				     PFsecure_bcounterop
			      end}.
...
merge_msg_ApbReadObjectResp(#'ApbReadObjectResp'{counter
    ...
    #'ApbReadObjectResp'{counter =
			 ...
			 secure_bcounter =
			     if PFsecure_bcounter /= undefined,
				NFsecure_bcounter /= undefined ->
				    merge_msg_ApbGetSecureBoundedCounterResp(PFsecure_bcounter,
									     NFsecure_bcounter,
									     TrUserData);
				PFsecure_bcounter == undefined ->
				    NFsecure_bcounter;
				NFsecure_bcounter == undefined ->
				    PFsecure_bcounter
			     end}.
...
v_msg_ApbSecureBoundedCounterUpdate(#'ApbSecureBoundedCounterUpdate'{inc
				    ...
				    Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_bytes(F1, [inc | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
       true -> v_type_bytes(F2, [dec | Path], TrUserData)
    end,
    if F3 == undefined -> ok;
       true -> v_type_bytes(F3, [nsquare | Path], TrUserData)
    end,
    ok;
...
-dialyzer({nowarn_function,v_msg_ApbGetSecureBoundedCounterResp/3}).
v_msg_ApbGetSecureBoundedCounterResp(#'ApbGetSecureBoundedCounterResp'{increments
									   = F1,
								       decrements
									   =
									   F2},
...
v_msg_ApbReadObjectResp(#'ApbReadObjectResp'{counter =
    ...
    if F8 == undefined -> ok;
       true ->
	   v_msg_ApbGetSecureBoundedCounterResp(F8,
						[secure_bcounter | Path],
						TrUserData)
    end,
    ok;
...
get_msg_defs() ->
    [{{enum, 'CRDT_type'},
     ...
     {{msg, 'ApbSecureBoundedCounterUpdate'},
      [#field{name = inc, fnum = 1, rnum = 2, type = bytes,
	      occurrence = optional, opts = []},
       #field{name = dec, fnum = 2, rnum = 3, type = bytes,
	      occurrence = optional, opts = []},
       #field{name = nsquare, fnum = 3, rnum = 4, type = bytes,
	      occurrence = optional, opts = []}]},
     ...
     {{msg, 'ApbUpdateOperation'},
      [#field{name = counterop, fnum = 1, rnum = 2,
       ...
       #field{name = flagop, fnum = 7, rnum = 7,
	      ...
	      opts = []},
       #field{name = secure_counterop, fnum = 8, rnum = 8,
	      type = {msg, 'ApbSecureCounterUpdate'},
	      occurrence = optional, opts = []},
       #field{name = secure_bcounterop, fnum = 9, rnum = 9,
     ...
     {{msg, 'ApbReadObjectResp'},
      [#field{name = counter, fnum = 1, rnum = 2,
       ...
       #field{name = flag, fnum = 7, rnum = 7,
	      ...
	      opts = []},
       #field{name = secure_counter, fnum = 8, rnum = 8,
	      type = {msg, 'ApbGetSecureCounterResp'},
	      occurrence = optional, opts = []},
       #field{name = secure_bcounter, fnum = 9, rnum = 9,
	      type = {msg, 'ApbGetSecureBoundedCounterResp'},
	      occurrence = optional, opts = []}]},
...
get_msg_containment("antidote") ->
    ['ApbAbortTransaction', 'ApbBoundObject',
     ...
     'ApbGetRegResp', 'ApbGetSecureBoundedCounterResp',
     'ApbGetSecureCounterResp', 'ApbGetSetResp',
...
get_proto_by_msg_name_as_fqbin(<<"ApbGetSecureBoundedCounterResp">>) -> "antidote";
