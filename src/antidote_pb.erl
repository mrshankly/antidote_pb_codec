...
%% enumerated types
-type 'CRDT_type'() :: 'COUNTER' | 'ORSET' | 'LWWREG' | 'MVREG' | 'GMAP' | 'RWSET' | 'RRMAP' | 'FATCOUNTER' | 'FLAG_EW' | 'FLAG_DW' | 'BCOUNTER' | 'SECUREORSET' | 'SECURERWSET' | 'SECURELWWREG' | 'SECUREMVREG' | 'SECUREGMAP' | 'SECURERRMAP'.
