...
-record('ApbMapKey',
        {key                    :: iodata(),        % = 1
         type                   :: 'COUNTER' | 'ORSET' | 'LWWREG' | 'MVREG' | 'GMAP' | 'RWSET' | 'RRMAP' | 'FATCOUNTER' | 'FLAG_EW' | 'FLAG_DW' | 'BCOUNTER' | 'SECURE_COUNTER' | 'SECURE_ORSET' | 'SECURE_LWWREG' | 'SECURE_MVREG' | 'SECURE_GMAP' | 'SECURE_RWSET' | 'SECURE_RRMAP' | integer() % = 2, enum CRDT_type
        }).
-endif.
...
-record('ApbUpdateOperation',
        {counterop              :: antidote_pb:'ApbCounterUpdate'() | undefined, % = 1
         ...
         secure_counterop       :: antidote_pb:'ApbSecureCounterUpdate'() | undefined % = 101
        }).
-endif.
...
-record('ApbReadObjectResp',
        {counter                :: antidote_pb:'ApbGetCounterResp'() | undefined, % = 1
         ...
         secure_counter         :: antidote_pb:'ApbGetSecureCounterResp'() | undefined, % = 101
         secure_set             :: antidote_pb:'ApbGetSetResp'() | undefined, % = 102
         secure_reg             :: antidote_pb:'ApbGetRegResp'() | undefined, % = 103
         secure_mvreg           :: antidote_pb:'ApbGetMVRegResp'() | undefined, % = 104
         secure_map             :: antidote_pb:'ApbGetMapResp'() | undefined % = 106
        }).
-endif.
