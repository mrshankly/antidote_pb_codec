...
-record('ApbMapKey',
        {key                    :: iodata(),        % = 1
         type                   :: 'COUNTER' | 'ORSET' | 'LWWREG' | 'MVREG' | 'GMAP' | 'RWSET' | 'RRMAP' | 'FATCOUNTER' | 'FLAG_EW' | 'FLAG_DW' | 'BCOUNTER' | 'SECUREORSET' | 'SECURERWSET' | 'SECURELWWREG' | 'SECUREMVREG' | 'SECUREGMAP' | 'SECURERRMAP' | integer() % = 2, enum CRDT_type
        }).
-endif.
